...
export interface Conversation {
  ...
  is_lead: boolean;
  /** True once a bot/agent question was followed by a substantive customer reply (real text/button-tap, not emoji/sticker/uncaptioned voice note) — deterministic, computed by this app from message content, independent of is_lead (which meta-ads/rollup.ts depends on for ad ROI reporting). */
