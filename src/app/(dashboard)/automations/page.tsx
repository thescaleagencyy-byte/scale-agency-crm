            ...
            {TEMPLATE_ORDER.map((slug) => {
              ...
              return (
                <button
                  ...
                  className="group flex flex-col items-start card-elevated p-4 text-left transition-colors hover:border-primary/50 hover:bg-card/80"
                >
...
function AutomationCard({
  ...
  return (
    <li className="card-elevated transition-colors hover:border-border">
